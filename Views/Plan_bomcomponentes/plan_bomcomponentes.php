            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist" id="nav-tab">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#agregarComponente" role="tab">
                                NUEVO
                            </a>
                        </li>
                    </ul>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="agregarComponente" role="tabpanel">
                            <form id="formBomComponentes" autocomplete="off" class="form-steps was-validated"
                                autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="listAlmacenes">ALMACEN</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text">Alm</span>
                                                <select class="form-control" name="listAlmacenes" id="listAlmacenes"
                                                    required></select>
                                                <div class="invalid-feedback">El campo almacen es obligatorio</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="listLineas">Descripción</label>
                                            <div class="input-group mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="nombre-estacion-input">LINEA DEL PRODUCTO</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="nombre-linea-addon">Lin</span>
                                                <input type="text" class="form-control"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="proceso-estacion-input">COSTO</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="proceso-linea-addon">Cos</span>
                                                <input type="text" class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="estandar-input">Ubicación</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="estandar-addon">ub</span>
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="unidad-medida-input">Tipo de Producto</label>
