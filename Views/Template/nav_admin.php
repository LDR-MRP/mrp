<div class="app-menu navbar-menu">
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarApps">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url(); ?>/usuarios" class="nav-link" data-key="t-calendar"> Usuarios
                                    </a>
                                </li>
                                <li class="nav-item">
                ...
                <?php if (!empty($_SESSION['permisos'][6]['r']) || !empty($_SESSION['permisos'][7]['r']) || !empty($_SESSION['permisos'][8]['r']) || !empty($_SESSION['permisos'][9]['r']) || !empty($_SESSION['permisos'][10]['r'])) { ?>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarPlaneacion" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="sidebarPlaneacion">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarPlaneacion">
                            <ul class="nav nav-sm flex-column">
                                <?php if (!empty($_SESSION['permisos'][6]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/plan_confproductosv1" class="nav-link"
                                            data-key="t-horizontal">Configuración de productos</a>
                                    </li>
                                <?php } ?>
                                ...
                                <?php if (!empty($_SESSION['permisos'][9]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/plan_planeacionv1" class="nav-link"
                                            data-key="t-two-column">Plan de producción</a>
                                ...
                                <?php if (!empty($_SESSION['permisos'][8]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/pla_productost" class="nav-link"
                                            data-key="t-detached">Productos Terminados - PT</a>
                                    </li>
                                <?php } ?>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebarTickets">
                                            <ul class="nav nav-sm flex-column">
                                                ...
                                                <?php if (!empty($_SESSION['permisos'][11]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/rpt_mrp_planeacion" class="nav-link"
                                                            data-key="t-list-view"> Indicadores OT </a>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                ...
                <?php if (
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarRequerimientos" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="sidebarRequerimientos">
                            ...
                            <li class="nav-item">
                               ...
                               */
                                ...
                                <?php if (!empty($_SESSION['permisos'][18]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/inv_inventario" class="nav-link" data-key="t-detached">Alta
                                            de inventario</a>
                                    </li>
                                <?php } ?>
                                ...
                                <?php if (!empty($_SESSION['permisos'][19]['r']) || !empty($_SESSION['permisos'][23]['r']) || !empty($_SESSION['permisos'][21]['r']) || !empty($_SESSION['permisos'][16]['r']) || !empty($_SESSION['permisos'][70]['r']) || !empty($_SESSION['permisos'][17]['r']) || !empty($_SESSION['permisos'][40]['r']) || !empty($_SESSION['permisos'][63]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)" class="nav-link flex-grow-1" data-key="t-detached"
                                            data-bs-toggle="collapse" data-bs-target="#subCatalogos" aria-expanded="false"
                                            aria-controls="subCatalogos">
                                            Catálogos
                                        </a>
                                        <div class="collapse ms-3" id="subCatalogos">
                                            <ul class="nav nav-sm flex-column">
                                                <?php if (!empty($_SESSION['permisos'][19]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_almacenes" class="nav-link"
                                                            data-key="t-detached">Almacenes</a>
                                                    </li>
                                                <?php } ?>

                                                <?php if (!empty($_SESSION['permisos'][23]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_concepmovinventarios" class="nav-link"
                                                            data-key="t-detached">Conceptos de movimientos</a>
                                                    </li>
                                                <?php } ?>

                                                <?php if (!empty($_SESSION['permisos'][63]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_descuentos" class="nav-link"
                                                            data-key="t-detached">Descuentos</a>
                                                    </li>
                                                <?php } ?>

                                                <?php if (!empty($_SESSION['permisos'][21]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_esquemaimpuestos" class="nav-link"
                                                            data-key="t-detached">Impuestos</a>
                                                    </li>
                                                <?php } ?>

                                                <?php if (!empty($_SESSION['permisos'][16]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_lineasdproducto" class="nav-link"
                                                            data-key="t-detached">Líneas de producto</a>
                                                    </li>
                                                <?php } ?>

                                                <?php if (!empty($_SESSION['permisos'][40]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/cli_marcas" class="nav-link"
                                                            data-key="t-detached">Marcas</a>
                                                    </li>
                                                <?php } ?>

                                                <?php if (!empty($_SESSION['permisos'][70]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_moneda" class="nav-link"
                                                            data-key="t-detached">Moneda</a>
                                                    </li>
                                                <?php } ?>

                                                <?php if (!empty($_SESSION['permisos'][17]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_precios" class="nav-link"
                                                            data-key="t-detached">Precios</a>
                                                    </li>
                                                <?php } ?>
                                ...
                                <?php if (!empty($_SESSION['permisos'][67]['r']) || !empty($_SESSION['permisos'][68]['r']) || !empty($_SESSION['permisos'][69]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)" class="nav-link flex-grow-1" data-key="t-detached"
                                            data-bs-toggle="collapse" data-bs-target="#subControlAlmacen" aria-expanded="false"
                                            aria-controls="subControlAlmacen">
                                            Control almacén
                                        </a>
                                        <div class="collapse ms-3" id="subControlAlmacen">
                                            <ul class="nav nav-sm flex-column">
                                                <?php if (!empty($_SESSION['permisos'][67]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_sedes" class="nav-link"
                                                            data-key="t-detached">Sedes</a>
                                                    </li>
                                                <?php } ?>

                                                <?php if (!empty($_SESSION['permisos'][68]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_zonas" class="nav-link"
                                                            data-key="t-detached">Zonas</a>
                                                    </li>
                                                <?php } ?>

                                                <?php if (!empty($_SESSION['permisos'][69]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_ubicaciones" class="nav-link"
                                                            data-key="t-detached">Ubicaciones</a>
                                                    </li>
                                                <?php } ?>
                                ...
                                <?php if (!empty($_SESSION['permisos'][24]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/inv_kardex" class="nav-link"
                                            data-key="t-detached">Kardex</a>
                                    </li>
                                <?php } ?>

                                <?php if (!empty($_SESSION['permisos'][25]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/inv_lotespedimentos" class="nav-link"
                                            data-key="t-detached">Lotes y pedimentos</a>
                                    </li>
                                <?php } ?>
                                ...
                                <?php if (!empty($_SESSION['permisos'][22]['r']) || !empty($_SESSION['permisos'][73]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)" class="nav-link flex-grow-1" data-key="t-detached"
                                            data-bs-toggle="collapse" data-bs-target="#subMovimientos" aria-expanded="false"
                                            aria-controls="subMovimientos">
                                            Movimientos
                                        </a>
                                        <div class="collapse ms-3" id="subMovimientos">
                                            <ul class="nav nav-sm flex-column">
                                                <?php if (!empty($_SESSION['permisos'][22]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_movimientosinventario" class="nav-link"
                                                            data-key="t-detached">Movimientos al inventario</a>
                                                    </li>
                                                <?php } ?>
                                                <?php if (!empty($_SESSION['permisos'][73]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_movimientosalmacenes" class="nav-link"
                                                            data-key="t-detached">Traspaso entre almacenes</a>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                                ...
                                <?php if (!empty($_SESSION['permisos'][26]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/inv_multialmacenes" class="nav-link"
                                            data-key="t-detached">Multialmacenes</a>
                                    </li>
                                <?php } ?>

                                <?php if (!empty($_SESSION['permisos'][74]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/inv_picking" class="nav-link"
                                            data-key="t-detached">Picking</a>
                                    </li>
                                <?php } ?>

                                <?php if (!empty($_SESSION['permisos'][20]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/inv_productossustitutos" class="nav-link"
                                            data-key="t-detached">Productos sustitutos</a>
                                    </li>
                                <?php } ?>

                                <?php if (!empty($_SESSION['permisos'][64]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/inv_recepcion" class="nav-link"
                                            data-key="t-detached">Recepción</a>
                                    </li>
                                <?php } ?>
                                ...
                                <?php if (!empty($_SESSION['permisos'][66]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/inv_tipo_cambio_moneda" class="nav-link"
                                            data-key="t-detached">Tipo de cambio</a>
                                    </li>
                                <?php } ?>

                                <?php if (!empty($_SESSION['permisos'][75]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/inv_traslados" class="nav-link"
                                            data-key="t-detached">Traslados de unidades</a>
                                    </li>
                                <?php } ?>

                                <?php if (!empty($_SESSION['permisos'][76]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/inv_operaciones_traslados" class="nav-link"
                                            data-key="t-detached">Operaciones traslado unidades</a>
                                    </li>
                                <?php } ?>
                                ...
                                <?php if (!empty($_SESSION['permisos'][71]['r']) || !empty($_SESSION['permisos'][65]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="javascript:void(0)" class="nav-link flex-grow-1" data-key="t-detached"
                                            data-bs-toggle="collapse" data-bs-target="#subVIN" aria-expanded="false"
                                            aria-controls="subVIN">
                                            VIN
                                        </a>
                                        <div class="collapse ms-3" id="subVIN">
                                            <ul class="nav nav-sm flex-column">
                                                ...
                                                <?php if (!empty($_SESSION['permisos'][65]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_captura_vin" class="nav-link"
                                                            data-key="t-detached">Captura glosario VIN</a>
                                                    </li>
                                                <?php } ?>
                                                <?php if (!empty($_SESSION['permisos'][71]['r'])) { ?>
                                                    <li class="nav-item">
                                                        <a href="<?= base_url(); ?>/inv_series" class="nav-link"
                                                            data-key="t-detached">Generar VIN</a>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                ...
                <?php if (!empty($_SESSION['permisos'][27]['r']) || !empty($_SESSION['permisos'][28]['r']) || !empty($_SESSION['permisos'][29]['r'])) { ?>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarCapacidad" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="sidebarCapacidad">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarCapacidad">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <?php if (!empty($_SESSION['permisos'][27]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/cap_estaciones" class="nav-link"
                                            data-key="t-detached">Estaciones</a>
                                    </li>
                                <?php } ?>
                                ...
                                <?php if (!empty($_SESSION['permisos'][28]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/cap_lineasdtrabajo" class="nav-link"
                                            data-key="t-detached">Líneas de producción</a>
                                    </li>
                                <?php } ?>

                                <?php if (!empty($_SESSION['permisos'][29]['r'])) { ?>
                                    <li class="nav-item">
                                        <a href="<?= base_url(); ?>/cap_plantas" class="nav-link"
                                            data-key="t-detached">Plantas</a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </div>
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url(); ?>/Lgs_ejecucion/chofer_movil" target="_blank"
                                    class="nav-link text-warning" data-key="t-lgs-chofer-movil">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url(); ?>/Lgs_ejecucion/entrega_destino" target="_blank"
                                    class="nav-link text-success" data-key="t-lgs-entrega-qr">
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item" data-permiso="PRV_PROVEEDORES|r">
                                <a href="<?= base_url(); ?>/prv_proveedor/reporte" class="nav-link">
                                    <i class="ri-shield-check-line align-bottom me-1"></i> Reporte Análitico de
                                    Onboarding
                                </a>
                            </li>
                ...
                <li class="nav-item" data-permiso="CXP_FACTURAS|r">
                    <a class="nav-link menu-link" href="#sidebarCxP" data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="sidebarCxP">
    ...
    <li class="nav-item">
        ...
        <a class="nav-link menu-link"
            href="#sidebarGestionPedidos"
            data-bs-toggle="collapse"
            role="button"
            aria-expanded="false"
            aria-controls="sidebarGestionPedidos">
        ...
        <div class="collapse menu-dropdown" id="sidebarGestionPedidos">
            ...
            <ul class="nav nav-sm flex-column">
                ...
                <!-- <li class="nav-item">
                    ...
                    <a href="<?= base_url(); ?>/ped_cotizaciones"
                        class="nav-link d-flex align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <a href="<?= base_url(); ?>/ped_autorizaciones"
                        class="nav-link d-flex align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <a href="<?= base_url(); ?>/ped_asignacion_unidades"
                        class="nav-link d-flex align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <a href="<?= base_url(); ?>/ped_backorders"
                        class="nav-link d-flex align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <a href="<?= base_url(); ?>/ped_cancelaciones"
                        class="nav-link d-flex align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <a href="<?= base_url(); ?>/ped_devoluciones"
                        class="nav-link d-flex align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <a href="<?= base_url(); ?>/ped_seguimiento"
                        class="nav-link d-flex align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <a href="<?= base_url(); ?>/ped_documentos"
                        class="nav-link d-flex align-items-center">
