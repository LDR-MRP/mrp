...
<head>
  ...
  <title>Notificación para Encargado de Estación</title>
...
<body>
  ...
  <div style="display:none; font-size:1px; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">
    Notificación para encargado: estación asignada en la OT <?= $data['num_orden'] ?? 'OT-2026-00087' ?>
  </div>
                            ...
                            <tr>
                              ...
                              <td style="vertical-align:middle;">
                                ...
                                <div style="font-size:20px; color:#111827; font-weight:800; margin-top:6px;">
                                  Notificación para Encargado de Estación
                                </div>
                              </td>
                            </tr>
                          </table>
