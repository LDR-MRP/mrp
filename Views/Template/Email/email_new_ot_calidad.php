...
<head>
  ...
  <title>Notificación para Encargado de Calidad</title>
...
<body>
  ...
  <div style="display:none; font-size:1px; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">
   Notificación de inspección de calidad asignada en la OT <?= $data['num_orden'] ?? 'OT-2026-00087' ?>
  </div>
                ...
                <tr>
                  <td style="padding: 6px 22px 8px;">
                    <div style="font-size:14px; color:#111827; line-height:1.55;">
                      ...
                      <br><br>
Se te asignó una inspección de <strong>Calidad / PDI</strong> para una orden de trabajo.
Es necesario realizar la validación de puntos críticos y registrar el resultado de inspección correspondiente antes de liberar la unidad.
                    </div>
                  </td>
                </tr>

                <!-- RESUMEN (PRIORIDAD / PLANTA / LÍNEA) -->
                <tr>
                    ...
                    <table role="presentation" width="100%" style="border:1px solid #e5e7eb; border-radius:12px;">
                      <tr class="stack">
                        <td style="padding: 12px 14px; border-right:1px solid #e5e7eb;">
                          <div style="font-size:12px; color:#6b7280;">Tipo de Inspección</div>
                          <div style="font-size:14px; color:#111827; font-weight:800; margin-top:4px;">
                                  <?= $data['calidad_asignada']['tipo'] ?? '—' ?>
                          </div>
                        </td>
                        <!-- <td style="padding: 12px 14px; border-right:1px solid #e5e7eb;">
                          <div style="font-size:12px; color:#6b7280;">Planta</div>
                          <div style="font-size:14px; color:#111827; font-weight:800; margin-top:4px;">
                            <?= $data['planta'] ?? 'PLT-03 · Ensamble' ?>
                          </div>
                        </td> -->
                        <td style="padding: 12px 14px;">
                          <div style="font-size:12px; color:#6b7280;">Línea</div>
                          <div style="font-size:14px; color:#111827; font-weight:800; margin-top:4px;">
                             <?= $data['calidad_asignada']['linea'] ?? '—' ?>
                          </div>
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td style="padding: 10px 22px 6px;">
                    <div style="font-size:14px; color:#111827; font-weight:800; margin-bottom:10px;">
                      Detalle de inspección asignada
                    </div>
                    ...
                    <table role="presentation" width="100%" style="border:1px solid #e5e7eb; border-radius:12px; overflow:hidden;">
                      <tr>
                        ...
                        <td style="background:#ffffff; padding:12px 14px; border-bottom:1px solid #e5e7eb; font-size:13px; color:#111827; font-weight:800;">
                          <?= $data['calidad_asignada']['nombre_estacion'] ?? '—' ?>
                        </td>
                      </tr>
                      ...
                      <!-- <tr>
                        ...
                        <td style="background:#ffffff; padding:12px 14px; font-size:13px; color:#111827;">
                          Confirmar preparación de estación, validar existencia de herramientas/componentes y reportar cualquier faltante antes del arranque.
                        </td>
                      </tr> -->
                    </table>
                  </td>
                ...
                <tr>
                  <td align="center" style="padding: 16px 22px 10px;">
                    <div style="font-size:13px; color:#6b7280; margin-bottom:12px;">
                      Para consultar el detalle completo y confirmar la preparación de tu estación, da click en el botón:
                    </div>
