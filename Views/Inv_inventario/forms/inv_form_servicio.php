<form id="formInventarioServicio" autocomplete="off" class="form-steps was-validated" autocomplete="off">
    <input type="hidden" id="idinventario" name="idinventario">
    <input type="hidden" name="tipo_elemento" value="S">
    <div class="row">
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="mb-3">
                <label class="form-label" for="lineaproductoid_servicio">LÍNEA DE PRODUCTO</label>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="nombre-linea-addon">Lin. Prod.</span>
                    <select class="form-control" id="lineaproductoid_servicio" name="lineaproductoid" required></select>
