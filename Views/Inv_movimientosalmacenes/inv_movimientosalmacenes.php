                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right d-flex align-items-center gap-2">
                            <?php if ($_SESSION['permisosMod']['w']) { ?>
                                <a href="<?= base_url() ?>/Inv_movalmcargamasiva" class="btn btn-success btn-sm">
                        ...
                        <div class="tab-pane" id="agregarMovimiento" role="tabpanel">
                            <form id="formMovimiento" autocomplete="off" class="was-validated">
                                ...
                                <div class="row g-3 mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label">Almacén origen</label>
                                        <select class="form-control" id="almacen_origenid" name="almacen_origenid" required></select>
                                    </div>

                                    <div class="col-md-4">
                                        <label class="form-label">Almacén destino</label>
                                        <select class="form-control" id="almacen_destinoid" name="almacen_destinoid" required></select>
                                    </div>
