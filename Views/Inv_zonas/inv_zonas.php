            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" id="nav-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#listzonas" role="tab">
                                ZONAS
                            </a>
                        </li>
                        <?php if ($_SESSION['permisosMod']['w']) { ?>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#agregarZona" role="tab">
                                    NUEVO
                                </a>
                            </li>
                        <?php } ?>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="listzonas" role="tabpanel">
                        ...
                        <div class="tab-pane" id="agregarZona" role="tabpanel">
                            <form id="formZonas" autocomplete="off" class="form-steps was-validated" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="clave-zona-input">CLAVE</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="clave-zona-addon">Clave</span>
                                                <input type="text" class="form-control"
                                                    placeholder="Ingresa la clave" id="clave-zona-input" name="clave-zona-input"
                                                    aria-describedby="clave-zona-addon" required>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="listSedes">SEDES</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="nombre-linea-addon" data-choices>Sed</span>
                                                <select class="form-control" id="listSedes" name="listSedes" required=""></select>
                                                <div class="invalid-feedback">El campo de sede es obligatorio</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- DESCRIPCIÓN -->
                                    <div class="mb-3">
                                        <label class="form-label" for="descripcion-zona-textarea">DESCRIPCIÓN</label>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="descripcion-zona-addon">Desc.</span>
                                            <textarea class="form-control" id="descripcion-zona-textarea" name="descripcion-zona-textarea"
                                                placeholder="Ingresa una descripción" rows="3"
                                                aria-describedby="descripcion-zona-addon" required></textarea>
