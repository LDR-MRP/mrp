# Reglas y Guía de Desarrollo para Agentes IA (Sistema MRP)

Este documento define la arquitectura, normas de codificación, convenciones de base de datos y flujo de trabajo con Git que **TODOS los agentes de Inteligencia Artificial y desarrolladores** deben seguir estrictamente al trabajar en este proyecto.
...
Todos los agentes y desarrolladores deben seguir este flujo de ramas:
...
## 📌 5. Lista de Verificación para Agentes IA
Antes de completar cualquier tarea de programación, los agentes deben verificar:
