		...
		if ($_SESSION['permisosMod']['r']) {
			...
			for ($i = 0; $i < count($arrData); $i++) {
				...
				if ($_SESSION['permisosMod']['u']) {
					$btnView = '
<li class="list-inline-item" data-bs-trigger="hover" data-bs-placement="top" title="Permisos">
    <button type="button" class="btn btn-link p-0 m-0 align-baseline text-primary d-inline-block"
        onclick="fntPermisos(' . $arrData[$i]['idrol'] . ')">
        <i class="ri-key-2-fill fs-16"></i>
    </button>
</li>';
...
<li class="list-inline-item edit" 
    ...
    <button type="button"
        class="btn btn-link p-0 border-0 text-primary d-inline-block edit-item-btn"
        onClick="fntEditRol(' . $arrData[$i]['idrol'] . ')">
    ...
    <button type="button"
        class="btn btn-link p-0 border-0 text-danger d-inline-block remove-item-btn"
        onClick="fntDelRol(' . $arrData[$i]['idrol'] . ')">
