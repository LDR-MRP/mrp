...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const btnGenerar = document.getElementById('btnGenerarPass');
    ...
    if (document.querySelector("#formUsuario")) {
        ...
        formUsuario.onsubmit = function(e) {
            ...
            let intPlantaid = document.querySelector('#listPlantaid').value;
            let strPassword = document.querySelector('#txtPassword').value;
            let intStatus = document.querySelector('#listStatus').value;

            if (strApellido == '' || strNombre == '' || strEmail == '' || intTelefono == '' || intTipousuario == '' || intPlantaid == '') {
...
function fntPlantasUsuario() {
    if (document.querySelector('#listPlantaid')) {
        let ajaxUrl = base_url + '/Usuarios/getSelectPlantas';
        let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
        request.open("GET", ajaxUrl, true);
        request.send();
        request.onreadystatechange = function() {
            if (request.readyState == 4 && request.status == 200) {
                document.querySelector('#listPlantaid').innerHTML = request.responseText;
                // $('#listPlantaid').selectpicker('render');
            }
        }
    }
}
    ...
    request.onreadystatechange = function() {
        ...
        if (request.readyState == 4 && request.status == 200) {
            ...
            if (objData.status) {
                ...
                // $('#listRolid').selectpicker('render');
                document.querySelector("#listPlantaid").value = objData.data.plantaid;
                // $('#listPlantaid').selectpicker('render');
