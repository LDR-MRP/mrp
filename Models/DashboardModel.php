<?php 
	class DashboardModel extends Mysql
	{
		...
		public function cantClientes(){
			$sql = "SELECT COUNT(*) as total FROM usuarios WHERE status != 0 AND rolid = ".RCLIENTES;
			$request = $this->select($sql);
			$total = $request['total']; 
			return $total;
		}
